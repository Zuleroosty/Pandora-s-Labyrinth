...
public class SaveGameHandler : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (PlayerPrefs.GetInt("saveGameAvaliable") != 1) PlayerPrefs.SetInt("saveGameAvaliable", 0); // CHECK IF SAVEGAME AVALIABLE - IF NO THEN SET TO 0 (NO SAVEGAME)
    }
    private void Update()
    {
    ...
    {
        PlayerPrefs.SetInt("saveGameAvaliable", 1); // SET SAVEGAME AVALIABLE FOR FUTURE USE
        ...
        // GAME STAT VARIABLES
        PlayerPrefs.SetInt("currentPlayLevel", gameStats.levelsCompleted + 1);
    ...
    public void LoadInfoFromFile()
    {
        ...
        // GAME STAT VARIABLES
        gameStats.levelsCompleted = PlayerPrefs.GetInt("currentPlayLevel");
