...
public class LevelHandler : MonoBehaviour
{
    ...
    void Update()
    {
        if (gameManager.gameState == GameManager.state.InGame) UpdateStats();
    ...
    void UpdateStats()
    {
        if (playerScript == null) playerScript = GameObject.Find("----PlayerObjectParent----").GetComponent<PlayerController>();
        ...
        averagePlayerLevel = (playerArmourLvl + playerSpearLvl) / 2;
    }
}
